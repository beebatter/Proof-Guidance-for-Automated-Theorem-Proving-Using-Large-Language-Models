...
*/
   ...
   {"load_ipremsel", py_load_ipremsel, METH_VARARGS, "(arg: filename) Load a premise selection file as a single graph"},
   {"load_cnfpremsel", py_load_cnfpremsel, METH_VARARGS, "(arg: filename) Load a premise selection file as a single graph (returns termstrings)"},
   {"load_cnfpremsel_real", py_load_cnfpremsel_real, METH_VARARGS, "(arg: filename) Load a premise selection file as a single graph (premise selection version)"},
