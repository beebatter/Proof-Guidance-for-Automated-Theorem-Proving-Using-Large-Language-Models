...
class GraphData():
    ...
    def __init__(self, raw_data = None):
        if raw_data is None: return
            ...
            if print_all:
                print("Node Inputs")
                print(self.node_inputs[0])
                print(len(self.node_inputs[0].lens), len(self.node_inputs[0].symbols), len(self.node_inputs[0].nodes))
                print(self.node_inputs[1])
                print(len(self.node_inputs[1].lens), len(self.node_inputs[1].symbols), len(self.node_inputs[1].nodes))
                print(self.node_inputs[2])
                print(len(self.node_inputs[2].lens), len(self.node_inputs[2].symbols), len(self.node_inputs[2].nodes))

                print("Symbol Inputs")
                print(self.symbol_inputs)

                print("Node C inputs")
                print(self.node_c_inputs)

                print("Clause Inputs")
                print(self.clause_inputs)

                print("Ini nodes")
                print(self.ini_nodes)
                #
                print("Ini symbols")
                print(self.ini_symbols)
                print("Number of symbols: ", len(self.ini_symbols))

                print("Ini Clauses")
                print(self.ini_clauses)
                print(sum(self.ini_clauses))
