...
#             echo "Default: All Slices"
            ...
            SLICE[0]="-ss axioms -sd 1 -st 1.0"; IPR[0]=" --abstr_ref [subs;sig;arg_filter] --abstr_ref_sig_restrict funpre --abstr_ref_af_restrict_to_split_sk true --abstr_ref_until_sat false "
            SLICE[1]="-ss axioms -sd 1 -st 2.0"; IPR[1]=" --abstr_ref [subs;sig;arg_filter] --abstr_ref_sig_restrict skc --abstr_ref_until_sat false "
            SLICE[2]="-ss axioms -sd 2 -st 1.0"; IPR[2]=" --abstr_ref [subs;sig;arg_filter] --abstr_ref_sig_restrict skc --abstr_ref_until_sat false "
            SLICE[3]="-ss axioms -sd 1 -st 1.0"; IPR[3]=" --abstr_ref [sig;arg_filter;subs] --abstr_ref_sig_restrict skc --abstr_ref_af_restrict_to_split_sk true --abstr_ref_until_sat false "
            SLICE[4]="-ss axioms -sd 1 -st 1.0"; IPR[4]=" --abstr_ref [subs;sig;arg_filter] --abstr_ref_sig_restrict funpre --abstr_ref_until_sat true "
            SLICE[5]="-ss axioms -sd 2 -st 1.0"; IPR[5]=" --abstr_ref [sig] --abstr_ref_sig_restrict skc --abstr_ref_until_sat false "
            SLICE[6]="-ss axioms -sd 1 -st 4.0"; IPR[6]=" --abstr_ref [subs;sig;arg_filter] --abstr_ref_sig_restrict funpre --abstr_ref_until_sat false "
            SLICE[7]="-ss axioms -sd 1 -st 1.0"; IPR[7]=" --abstr_ref [arg_filter;sig;subs] --abstr_ref_sig_restrict skc --abstr_ref_af_restrict_to_split_sk true --abstr_ref_until_sat false "
            SLICE[8]="-ss axioms -sd 1 -st 8.0"; IPR[8]=" --abstr_ref [subs;sig;arg_filter] --abstr_ref_sig_restrict funpre --abstr_ref_until_sat false "
            SLICE[9]="-ss axioms -sd 1 -st 1.0"; IPR[9]=" --abstr_ref [subs;sig;arg_filter] --abstr_ref_sig_restrict skc --abstr_ref_until_sat false "
            SLICE[10]="-ss axioms -sd 1 -st 2.0";IPR[10]=" --abstr_ref [sig;arg_filter;subs] --abstr_ref_sig_restrict skc --abstr_ref_af_restrict_to_split_sk true --abstr_ref_until_sat false "
            SLICE[11]=" "
