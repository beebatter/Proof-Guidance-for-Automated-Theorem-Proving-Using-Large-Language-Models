...
#(ulimit -s $ULIMIT; $TreeLimitedRun "$Dir/iprover_sat_single.sh" "$TIMELIMIT" "$Dir/iproveropt" "--schedule none --out_options none --sat_mode true --sat_finite_models true --sat_fm_uc_incr true --bc_imp_inh "[]" --inst_prop_sim_given false --inst_prop_sim_new false --reset_solvers false --inst_lit_activity_flag false --clausifier $EClausifier " 1 " --out_options none --clausifier $EClausifier " 1/4 "--schedule none --out_options none --sat_mode true --sat_finite_models true --sat_fm_uc_incr true --bc_imp_inh "[]" --inst_prop_sim_given false --inst_prop_sim_new false --reset_solvers false --inst_lit_activity_flag false --clausifier $VClausifier" 1/10 "$Problem")

OTPS_SAT_26357=$(cat $Dir/options_exp/opts_2018_06_26357_sat.txt)

ulimit -s $ULIMIT; $TreeLimitedRun "$Dir/iprover_sat_single.sh" "$TIMELIMIT" "$Dir/iproveropt" "$OTPS_SAT_26357 " 1 " --out_options none --clausifier $EClausifier " 1/4 "--schedule none --out_options none --sat_mode true --sat_finite_models true --sat_fm_uc_incr true --bc_imp_inh "[]" --inst_prop_sim_given false --inst_prop_sim_new false --reset_solvers false --inst_lit_activity_flag false --clausifier $VClausifier" 1/10 " --schedule none --instantiation_flag false --res_time_limit 400 --res_lit_sel neg_max --res_lit_sel_side num_symb --splitting_mode input --res_passive_queues [[+age;+num_var;-num_symb];[+age;-num_symb;-num_var]] --res_prop_simpl_given false " 1/15 "$Problem"
