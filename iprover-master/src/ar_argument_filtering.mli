...
(** This module implements the argument filtering abstraction, which is an
    over-approximating abstraction. *)

type details
(** The type of the details of the argument filtering abstraction. *)

val abstract: Options.options -> LI.BCSet.t -> AD.t * details
(** [abstract o cs] abstracts a set of clauses [cs] using the argument filtering
    abstraction. *)
...
(** The empty details of the argument filtering abstraction. *)
