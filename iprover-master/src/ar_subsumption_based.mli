...
(** This module implements the subsumption based abstraction, which is an
    over-approximating abstraction. *)

type details
(** The type of the details of the subsumption based abstraction. *)

val abstract: Options.options -> LI.BCSet.t -> AD.t * details
(** [abstract o cs] abstracts a set of clauses [cs] using the subsumption based
    abstraction. *)
...
(** The empty details of the subsumption based abstraction. *)
