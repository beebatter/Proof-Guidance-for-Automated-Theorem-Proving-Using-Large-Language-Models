...
(* Matching index, primarily for demodulation *)
...
let module_name = "matchingIndexDiscrTree"
...
let elim_filter_from_lit ui lit func =
  ...
  | Empty_Elem ->
    failwith "elim_clause_with_sel: matching index should not contain Empty_Elem"
...
let eliminate_lit ui lit =
  ...
  | Empty_Elem ->
    failwith "eliminate_lit: matching index should not contain Empty_Elem"
...
let in_index ui lit = TSet.mem lit ui.terms
