...
(** More flexibility: [elim_filter_from_lit index lit func] allows to remove 
    from [index], indexed by [lit], those elements [x] for which [func x = true] *)
